 ...
 *          Try "ctrl + left-click" on the text "String" to see the source 
 * code of the String class.
 * 
 * An object is an instantiation of a class.
 * We would like objects to be able to:
 *      a) contain some data
 *      and
 *      b) change its behavior based off of the data that it individually 
 * contains.
 *
 * Let's say we're working on a birdwatching app.
 * Using OOP, we could maintain many bird objects which individually contain 
 * their own
 * age, and can generate their own sound. This concept of an object 
 * controlling its own data can be
 * referred to as encapsulation.
 *
 * In the app, an individual bird should be able to "Tweet" if ageMonths is 
 * less than 3 and "Chirp" if ageMonths is
...
public class Bird {
    ...
    /**
     * A constructor for the bird class: this method allows us to build a new 
     * bird with the 'new' keyword.
